...
trait ImageVersionsTrait
{
     ...
     */
    public function getImageVersions(EntityInterface $entity, array $options = []): array
    {
     ...
     */
    protected function _getImageVersionData(EntityInterface $entity, array $options = []): array
    {
        ...
        $versionData['original'] = $options['originalVersion'] ?? 'original';
